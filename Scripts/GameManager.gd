...
const GameManagerSerializerScript: GDScript = preload("res://Scripts/GameManagerSerializer.gd")
...
var _serializer: RefCounted = GameManagerSerializerScript.new()
...
func _serialize_dice_pool() -> Array[Dictionary]:
	return _serializer.serialize_dice_pool(dice_pool)


func _deserialize_dice_pool(raw_data: Array) -> Array:
	return _serializer.deserialize_dice_pool(raw_data)


func _serialize_modifiers() -> Array[Dictionary]:
	return _serializer.serialize_modifiers(active_modifiers)


func _deserialize_modifiers(raw_data: Array) -> Array:
	return _serializer.deserialize_modifiers(raw_data)
